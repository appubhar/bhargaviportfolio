	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'glow': {
					'0%, 100%': {
						boxShadow: '0 0 20px hsl(var(--glow-purple) / 0.3)'
					},
					'50%': {
						boxShadow: '0 0 40px hsl(var(--glow-purple) / 0.6)'
					}
				},
				'float': {
				...
				'hover-glow': {
					'0%': { boxShadow: '0 0 10px hsl(var(--lavender) / 0.3)' },
					'100%': { boxShadow: '0 0 25px hsl(var(--lavender) / 0.6)' }
				}
			},
			animation: {
